...
CREATE TABLE IF NOT EXISTS Utilisateur (
    ...
    Email VARCHAR(255),
    Adresse TEXT,
    roleutilisateur VARCHAR(10) CHECK (roleutilisateur IN ('USER', 'ADMIN')),
...
CREATE TABLE IF NOT EXISTS DemandeDevise (
    ...
    Statut VARCHAR(15) CHECK (Statut IN ('ENATTENTE', 'ENCOURS', 'ACCEPTER',
                              'PAYER',
                              'ANNULER',
                              'TERMINER')),
...
CREATE TABLE IF NOT EXISTS OffreDevise (
    ...
    Statut  VARCHAR(15) CHECK (Statut IN ('ENATTENTE', 'ACCEPTER', 'REFUSER', 'PAYER',
                               'ANNULER', 'TERMINER')),
